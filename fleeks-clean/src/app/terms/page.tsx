      ...
      <main className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        >
          ...
          <div className="space-y-6 text-gray-200">
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第1条（適用）</h2>
              <p>
                本規約は、FLEEKS（以下「当サービス」といいます。）の利用条件を定めるものです。
                登録ユーザーの皆さま（以下「ユーザー」といいます。）には、本規約に従って、当サービスをご利用いただきます。
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第2条（利用登録）</h2>
              <p>
                1. 当サービスにおいては、登録希望者が本規約に同意の上、当社の定める方法によって利用登録を申請し、
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第3条（ユーザーIDおよびパスワードの管理）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第4条（利用料金および支払方法）</h2>
              <p>
                1. ユーザーは、当サービスの有料部分の対価として、当社が別途定め、
                当サービスに表示する利用料金を、当社が指定する方法により支払うものとします。
              </p>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第5条（禁止事項）</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第6条（本サービスの提供の停止等）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第7条（利用制限および登録抹消）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第8条（退会）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第9条（保証の否認および免責事項）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第10条（サービス内容の変更等）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第11条（利用規約の変更）</h2>
              <p>
                1. 当社は以下の場合には、ユーザーの個別の同意を要せず、本規約を変更することができるものとします。
              </p>
              <ul className="list-disc list-inside ml-4 mt-2">
                <li>本規約の変更がユーザーの一般の利益に適合するとき</li>
                <li>本規約の変更が本サービス利用契約の目的に反せず、かつ、変更の必要性、
                変更後の内容の相当性その他の変更に係る事情に照らして合理的なものであるとき</li>
              </ul>
            </section>

            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第12条（個人情報の取扱い）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第13条（通知または連絡）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第14条（権利義務の譲渡の禁止）</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3 text-white">第15条（準拠法・裁判管轄）</h2>
              <p>
